...
* CLI functions:
  ...
  ```
	* when used as a core bashutils function **MUST** follow the naming schema ```bashutils[.${context}.]${function_name}```
	* **MUST** always return 0 when success and not 0 when fail

## License

By contributing to bashUtils, you agree that your contributions will be licensed under the [Apache License Version 2.0 (APLv2)](LICENSE).
